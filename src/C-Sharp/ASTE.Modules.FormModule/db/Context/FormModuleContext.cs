...
namespace ASTE.Modules.FormModule.db.Context
{
    /// <summary>
    /// FormModule DB Context
    /// </summary>
    public class FormModuleContext : DbContext
    {
        public FormModuleContext(string connectionstring) : base(connectionstring){ }
        public FormModuleContext() {
    ...
    public class FormModuleInitializer : CreateDatabaseIfNotExists<FormModuleContext>
    {

        protected override void Seed(FormModuleContext context) 
        {
            ///Creates initial Questions for the Demo
